...
class Web(object):
    ...
    def find_by_css_selector(self, css_selector: str):
        return self._web_driver_wait.until(ec.visibility_of_element_located((By.CSS_SELECTOR, css_selector)))

    def finds_by_css_selector(self, css_selector: str):
        return self._web_driver_wait.until(ec.presence_of_all_elements_located((By.CSS_SELECTOR, css_selector)))
